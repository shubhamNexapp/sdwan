...
import ServerTunnel from '@/components/standalone/ipsec_tunnel/ServerTunnelView.vue'
import ClientTunnel from '@/components/standalone/ipsec_tunnel/ClientTunnelView.vue'
...
<template>
  ...
  <div>
    ...
    />
    <ServerTunnel :manageClientTunnels="false" v-if="selectedTab == 'server-tunnel'" />
    <ClientTunnel :manageClientTunnels="true" v-else />
  </div>
</template>
